  ...
  <div class="body-wrapper">
    ...
    <div class="footer-messages clearfix">
      <div class="powered_by_content">
	    <div class="support_powered_by">
		  <span class="powered_by_text">powered by</span>
		  <span class="drupal_text"> <a href="http://drupal.org">Drupal</a></span> <br /> 
		  <span class="supported_by_text">supported and maintained by</span>
		  <span class="bs_text"> <a href="http://www.brightsolutions.de">Bright Solutions GmbH</a></span>
		</div>
		<div class="bs_powered_by_logo"></div>
	  </div>
    </div>
