...
function _erpal_maintenance_get_screencasts($max_entrys){
  //########## Render static videos ###########
  $screencasts = _erpal_maintenance_get_videos();
...
/**
* Add some static youtub introduction videos
*/
function _erpal_maintenance_get_videos() {
  $screencasts = array();
  $screencasts[] = array(
    'image' => htmlspecialchars('https://i.ytimg.com/vi_webp/ro_bYgFsicM/mqdefault.webp'),
    'title' => '01 - Processes and workflows - A Complete overview',
    'link' => 'https://www.youtube.com/watch?v=ro_bYgFsicM',
  );
  
  $screencasts[] = array(
    'image' => htmlspecialchars('https://i.ytimg.com/vi_webp/4tWfwx1TtLk/mqdefault.webp'),
    'title' => '02 - Working with the CRM and sales activities',
    'link' => 'https://www.youtube.com/watch?v=4tWfwx1TtLk',
  );
  
  $screencasts[] = array(
    'image' => htmlspecialchars('https://i.ytimg.com/vi_webp/yFeoA7NPU_0/mqdefault.webp'),
    'title' => '03 - How to manage and control projects',
    'link' => 'https://www.youtube.com/watch?v=yFeoA7NPU_0',
  );
