  ...
  attach: function (context) {
    $('.horizontal-tabs-panes', context).once('horizontal-tabs', function () {
      ...
      $fieldsets.each(function (i) {
        ...
        // Extract group name and add as class to button.
        var id = $($fieldsets.get(i)).attr('id');
        var offset = id.indexOf('group');
        var field_name = id.substring(offset, id.length);
        horizontal_tab.item.addClass(field_name);
